...
import 'package:flutter_chat_messenger/model/message.dart';
...
class ChatService extends ChangeNotifier {
  ...
  Stream<QuerySnapshot> getMessages(String userId, String otherUserId) {
    // construct chat room id from user ids (sorted to enssure it wathces the id used when sending messages)
